...
class TestPropertyManager:
    ...
    def test_init_creates_28_properties(self, property_manager: PropertyManager) -> None:
    ...
    def test_get_valid_position(self, property_manager: PropertyManager) -> None:
        """get should return property for valid position."""
        prop = property_manager.get(1)
        assert prop is not None
        assert prop.position == 1

    def test_get_invalid_position(self, property_manager: PropertyManager) -> None:
    ...
    def test_get_owned_by(self, property_manager_with_owner: PropertyManager) -> None:
    ...
    def test_get_unowned(self, property_manager_with_owner: PropertyManager) -> None:
    ...
    def test_has_monopoly_true(self, property_manager_with_owner: PropertyManager) -> None:
    ...
    def test_has_monopoly_false(self, property_manager: PropertyManager) -> None:
    ...
    def test_get_monopolies(self, property_manager_with_monopoly: PropertyManager) -> None:
    ...
    def test_count_railroads_owned(self, property_manager: PropertyManager) -> None:
    ...
    def test_count_utilities_owned(self, property_manager: PropertyManager) -> None:
    ...
    def test_count_houses_in_group(self, property_manager_with_houses: PropertyManager) -> None:
        """count_houses_in_group should count houses in a monopoly."""
        # Light blue has 3 properties with 2 houses each = 6 houses
        count = property_manager_with_houses.count_houses_in_group(0, PropertyColor.LIGHT_BLUE)
        assert count == 6

    def test_count_hotels_in_group(self, property_manager_with_monopoly: PropertyManager) -> None:
        """count_hotels_in_group should count hotels."""
        # No hotels initially
        count = property_manager_with_monopoly.count_hotels_in_group(0, PropertyColor.LIGHT_BLUE)
        assert count == 0
    ...
    def test_get_min_houses_in_group(self, property_manager_with_monopoly: PropertyManager) -> None:
        """get_min_houses_in_group should return minimum."""
        # All start with 0
        assert property_manager_with_monopoly.get_min_houses_in_group(PropertyColor.LIGHT_BLUE) == 0
    ...
    def test_get_max_houses_in_group(self, property_manager_with_houses: PropertyManager) -> None:
        """get_max_houses_in_group should return maximum."""
        # All have 2 houses
        assert property_manager_with_houses.get_max_houses_in_group(PropertyColor.LIGHT_BLUE) == 2

    def test_can_build_house_on(self, property_manager_with_monopoly: PropertyManager) -> None:
    ...
    def test_can_build_evenly(self, property_manager_with_monopoly: PropertyManager) -> None:
    ...
    def test_can_sell_house_on(self, property_manager_with_houses: PropertyManager) -> None:
    ...
    def test_can_sell_evenly(self, property_manager_with_houses: PropertyManager) -> None:
    ...
    def test_transfer_property(self, property_manager: PropertyManager) -> None:
    ...
    def test_reset_property(self, property_manager: PropertyManager) -> None:
    ...
    def test_to_dict(self, property_manager_with_owner: PropertyManager) -> None:
    ...
    def test_from_dict(self) -> None:
        ...
        data = {"1": {"position": 1, "owner": 0, "houses": 2, "mortgaged": False}}
